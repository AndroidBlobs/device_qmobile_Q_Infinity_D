PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    persist.tcf.app.start.control=true \
    persist.tcf.location.optimize=0 \
    persist.tcf.save.feature=true \
    ...
    ro.config.no_multi_touch=1 \
    ro.config.notification_sound=Blink.ogg \
    ro.config.ringtone=Noir.ogg \
    ro.config.wallpaper=system/etc/default_theme_icon/wallpaper/lock_wallpaper.png \
    ro.control_privapp_permissions=log \
    ro.custom.build.version=QMobile_Q_Infinity_D_MP_V6.0_28_04 \
    ro.email_support_ucs2=0 \
    ro.feature.background.dexopt=true \
    ro.feature.omacp.nopincode=1 \
    ro.feature.rm.leather.menu=true \
    ro.feature.screencorner=true \
    ro.feature.singlehand=true \
    ro.feature.smartgesture=false \
    ro.feature.smartscreenshot=true \
    ro.frp.pst=/dev/block/platform/mtk-msdc.0/11120000.msdc0/by-name/frp \
    ro.have_aacencode_feature=1 \
    ro.have_aee_feature=1 \
    ro.internal.build.version=K200AG_1G_QMB_PK_OM_18_14 \
    ro.ksc5601_write=0 \
    ...
    ro.mediatek.version.release=alps-mp-o1.mp2-V1.42_k80hd.bsp.fwv.512m_TMP1 \
    ...
    ro.smallscreen.version=v8.1.11.04 \
    ro.sys.sdcardfs=1 \
    ro.target=k200_1g \
    ro.tcustom.build.version=QMobile_Q_Infinity_D_MP_V6.0_28_04 \
    ro.telephony.default_network=0,0 \
    ro.telephony.sim.count=2 \
    ro.tinno.batterywarn=true \
    ro.ussd_ksc5601=0 \
